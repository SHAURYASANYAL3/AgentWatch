...
def fix_tests():
    # Fix test_verify_env.py
    with open('tests/test_verify_env.py', 'r', encoding='utf-8') as f:
        content = f.read()
    
    content = content.replace('["verify-env"]', '["check-env"]')
    
    with open('tests/test_verify_env.py', 'w', encoding='utf-8') as f:
        f.write(content)

    # Fix test_cli_status.py
    test_cli_status_code = """import json
...
"""
    ...
    with open('tests/test_cli_status.py', 'w', encoding='utf-8') as f:
        f.write(test_cli_status_code)
